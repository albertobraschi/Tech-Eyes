...
class Ess_M2ePro_Model_Support
{
    ...
    public function send($data)
    {
        ...
        $component = 'None';
        $data['component'] == Ess_M2ePro_Helper_Component_Ebay::NICK   && $component = Ess_M2ePro_Helper_Component_Ebay::TITLE;
        $data['component'] == Ess_M2ePro_Helper_Component_Amazon::NICK && $component = Ess_M2ePro_Helper_Component_Amazon::TITLE;
