                    ...
                    if ($rez !== false) {
                          ...
                          foreach ($listingsArray as $listingTemp) {
                                 ...
                                 $tempLog->addProductMessage($listingTemp['id'],
                                                             ...
                                                             Mage::getModel('M2ePro/Log_Abstract')->encodeDescription('From [%from%] to [%to%]',array('!from'=>$qtyOld,'!to'=>$qtyNew)),
                    ...
                    if ($rez !== false) {
                          ...
                          foreach ($listingsArray as $listingTemp) {
                                 ...
                                 $tempLog->addProductMessage($listingTemp['id'],
                                                             ...
                                                             Mage::getModel('M2ePro/Log_Abstract')->encodeDescription('From [%from%] to [%to%]',array('from'=>$stockAvailabilityOld,'to'=>$stockAvailabilityNew)),
                                                             Ess_M2ePro_Model_Log_Abstract::TYPE_NOTICE,
                                                             Ess_M2ePro_Model_Log_Abstract::PRIORITY_LOW );
                          }
                    }
