...
class Ess_M2ePro_Model_Synchronization_Dispatcher extends Ess_M2ePro_Model_Synchronization_Dispatcher_Abstract
{
    ...
    private function beforeDispatch()
    {
        ...
        Mage::helper('M2ePro')->setGlobalValue('synchId',Mage::helper('M2ePro')->getGlobalValue('synchRun')->getLastId());
        //----------------------------------
        ...
        Mage::helper('M2ePro')->getGlobalValue('synchLogs')->setSynchronizationRun(Mage::helper('M2ePro')->getGlobalValue('synchId'));
        Mage::helper('M2ePro')->getGlobalValue('synchLogs')->setSynchronizationTask(Ess_M2ePro_Model_Synchronization_Log::SYNCH_TASK_UNKNOWN);
        ...
        if (Mage::helper('M2ePro')->getGlobalValue('synchLockItem')->isExist()) {
            ...
            Mage::helper('M2ePro')->getGlobalValue('synchLogs')->addMessage(Mage::helper('M2ePro')->__('Another Synchronization Is Already Running'),
                                                    Ess_M2ePro_Model_Log_Abstract::TYPE_WARNING,
                                                    Ess_M2ePro_Model_Log_Abstract::PRIORITY_MEDIUM);
            Mage::helper('M2ePro')->getGlobalValue('synchProfiler')->addTitle('Another Synchronization Is Already Running.',Ess_M2ePro_Model_General_Profiler::TYPE_ERROR);
            return false;
        }
    ...
    {
        $functionCode = 'Mage::getModel(\'M2ePro/ProductChange\')->clearAll(Ess_M2ePro_Model_ProductChange::CREATOR_TYPE_OBSERVER,\''.$this->startTime.'\');';
        $functionCode .= 'Mage::getModel(\'M2ePro/ProductChange\')->clearAll(Ess_M2ePro_Model_ProductChange::CREATOR_TYPE_SYNCHRONIZATION);';
