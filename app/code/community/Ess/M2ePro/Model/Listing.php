...
class Ess_M2ePro_Model_Listing extends Ess_M2ePro_Model_Component_Parent_Abstract
{
    ...
    public function getGeneralTemplate()
    {
        if (is_null($this->generalTemplateModel)) {
            $this->generalTemplateModel = Mage::helper('M2ePro/Component')->getComponentObject($this->getComponentMode(),'Template_General',$this->getData('template_general_id'));
        }
    ...
    public function getSellingFormatTemplate()
    {
        if (is_null($this->sellingFormatTemplateModel)) {
            $this->sellingFormatTemplateModel = Mage::helper('M2ePro/Component')->getComponentObject($this->getComponentMode(),'Template_SellingFormat',$this->getData('template_selling_format_id'));
        }
    ...
    public function getDescriptionTemplate()
    {
        if (is_null($this->descriptionTemplateModel)) {
            $this->descriptionTemplateModel = Mage::helper('M2ePro/Component')->getComponentObject($this->getComponentMode(),'Template_Description',$this->getData('template_description_id'));
        }
    ...
    public function getSynchronizationTemplate()
    {
        if (is_null($this->synchronizationTemplateModel)) {
            $this->synchronizationTemplateModel = Mage::helper('M2ePro/Component')->getComponentObject($this->getComponentMode(),'Template_Synchronization',$this->getData('template_synchronization_id'));
        }
    ...
    {
        return $this->getRelatedComponentItems('Listing_Product','listing_id',$asObjects,$filters);
    }
    ...
    public function addProduct($product)
    {
        ...
        if ($this->getComponentMode() == Ess_M2ePro_Helper_Component_Amazon::NICK) {
            ...
            if ($productType != Ess_M2ePro_Model_Magento_Product::TYPE_SIMPLE) {
                return false;
            }
        }
