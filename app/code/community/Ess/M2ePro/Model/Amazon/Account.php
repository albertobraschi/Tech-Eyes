...
class Ess_M2ePro_Model_Amazon_Account extends Ess_M2ePro_Model_Component_Child_Amazon_Abstract
{
    ...
    {
        $setting = $this->getSetting('other_listings_mapping_settings', array('general_id', 'mode'), self::OTHER_LISTINGS_MAPPING_GENERAL_ID_MODE_NONE);
    ...
    {
        $setting = $this->getSetting('other_listings_mapping_settings', array('general_id', 'priority'), self::OTHER_LISTINGS_MAPPING_GENERAL_ID_DEFAULT_PRIORITY);
    ...
    {
        $setting = $this->getSetting('other_listings_mapping_settings', array('sku', 'mode'), self::OTHER_LISTINGS_MAPPING_SKU_MODE_NONE);
    ...
    {
        $setting = $this->getSetting('other_listings_mapping_settings', array('sku', 'priority'), self::OTHER_LISTINGS_MAPPING_SKU_DEFAULT_PRIORITY);
    ...
    {
        $setting = $this->getSetting('other_listings_mapping_settings', array('sku', 'attribute'));
    ...
    {
        $setting = $this->getSetting('other_listings_mapping_settings', array('title', 'mode'), self::OTHER_LISTINGS_MAPPING_TITLE_MODE_NONE);
    ...
    {
        $setting = $this->getSetting('other_listings_mapping_settings', array('title', 'priority'), self::OTHER_LISTINGS_MAPPING_TITLE_DEFAULT_PRIORITY);
    ...
    {
        return $this->getOtherListingsMappingGeneralIdMode() == self::OTHER_LISTINGS_MAPPING_GENERAL_ID_MODE_CUSTOM_ATTRIBUTE;
    }
    ...
    public function addMarketplaceItem($marketplaceId, $serverHash, $accountMerchantId, $accountMarketplaceId, $relatedStoreId = 0, array $info = array())
    {
        $newData = $this->createMarketplaceData($serverHash, $accountMerchantId, $accountMarketplaceId, $relatedStoreId, $info);
        $this->setMarketplaceIdData($marketplaceId,$newData);
        $this->save();
    }

    public function updateMarketplaceItem($marketplaceId, $accountMerchantId, $accountMarketplaceId, $relatedStoreId = 0, array $info = array())
    {
        ...
        $newData = $this->createMarketplaceData($data['server_hash'], $accountMerchantId, $accountMarketplaceId, $relatedStoreId, $info);
    ...
    private function createMarketplaceData($serverHash, $accountMerchantId, $accountMarketplaceId, $relatedStoreId = 0, array $info = array())
    {
        return array(
            'server_hash' => (string)$serverHash,
            'merchant_id' => (string)$accountMerchantId,
            'marketplace_id' => (string)$accountMarketplaceId,
