...
abstract class Ess_M2ePro_Model_Order_Item_Proxy
{
    ...
    /**
     * Set item object which should be a source for magento order item
     *
     * @param Ess_M2ePro_Model_Component_Child_Abstract $item
     * @return Ess_M2ePro_Model_Order_Item_Proxy
     */
    public function setItem(Ess_M2ePro_Model_Component_Child_Abstract $item)
    {
        $this->item = $item;
