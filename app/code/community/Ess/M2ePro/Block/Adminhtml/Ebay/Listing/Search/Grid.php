...
class Ess_M2ePro_Block_Adminhtml_Ebay_Listing_Search_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()
                   ...
                   ->joinLeft(array('ebit'=>Mage::getResourceModel('M2ePro/Ebay_Item')->getMainTable()), '(`ebit`.`id` = `second_table`.`ebay_item_id`)',array('item_id'));
        //--------------------------------
    ...
    public function callbackColumnOnlineBuyItNowPrice($value, $row, $column, $isExport)
    {
        ...
        $sellingFormatTemplate = Mage::getModel('M2ePro/Template_SellingFormat')->loadInstance($row->getData('template_selling_format_id'));
    ...
    public function callbackColumnActions($value, $row, $column, $isExport)
    {
        ...
        $link = $this->getUrl('*/adminhtml_ebay_listing/view/',array('id'=>$row->getData('listing_id'),
