...
class Ess_M2ePro_Block_Adminhtml_Ebay_Listing extends Mage_Adminhtml_Block_Widget_Grid_Container
{
	...
	public function __construct()
	{
        ...
        $this->_addButton('goto_listing_other', array(
            ...
            'onclick'   => 'setLocation(\''.$this->getUrl('*/adminhtml_listingOther/index',array('tab' => Ess_M2ePro_Block_Adminhtml_Component_Abstract::TAB_ID_EBAY,'back'=>Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_listing/index',array('tab'=>Ess_M2ePro_Block_Adminhtml_Component_Abstract::TAB_ID_EBAY)))).'\')',
            'class'     => 'button_link'
        ));
        ...
        $this->_addButton('view_log', array(
            ...
            'onclick'   => 'setLocation(\''.$this->getUrl('*/adminhtml_log/listing', array('back' => Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_listing/index',array('tab'=>Ess_M2ePro_Block_Adminhtml_Component_Abstract::TAB_ID_EBAY)), 'filter' => base64_encode('component_mode=' . Ess_M2ePro_Helper_Component_Ebay::NICK))).'\')',
            'class'     => 'button_link'
        ));

        $this->_addButton('search_ebay_products', array(
            'label'     => Mage::helper('M2ePro')->__('Search Items'),
            'onclick'   => 'setLocation(\''.$this->getUrl('*/adminhtml_ebay_listing/search', array('back' => Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_listing/index', array('tab' => Ess_M2ePro_Block_Adminhtml_Component_Abstract::TAB_ID_EBAY)))).'\')',
        ...
        $this->_addButton('add', array(
            ...
            'onclick'   => 'setLocation(\'' .$this->getUrl('*/adminhtml_ebay_listing/add',array('step'=>'1','clear'=>'yes')).'\')',
            'class'     => 'add'
        ));
        //------------------------------
	}
...
JAVASCRIPT;
    ...
    protected function getTemplatesButtonDropDownHtml()
    {
        ...
        $sellingFormatUrl = $this->getUrl('*/adminhtml_template_sellingFormat/index', array('filter' => base64_encode('component_mode=' . Ess_M2ePro_Helper_Component_Ebay::NICK)));

        $description = Mage::helper('M2ePro')->__('Description');
        $descriptionUrl = $this->getUrl('*/adminhtml_template_description/index', array('filter' => base64_encode('component_mode=' . Ess_M2ePro_Helper_Component_Ebay::NICK)));

        $general = Mage::helper('M2ePro')->__('General');
        $generalUrl = $this->getUrl('*/adminhtml_template_general/index', array('filter' => base64_encode('component_mode=' . Ess_M2ePro_Helper_Component_Ebay::NICK)));

        $synchronization = Mage::helper('M2ePro')->__('Synchronization');
        $synchronizationUrl = $this->getUrl('*/adminhtml_template_synchronization/index', array('filter' => base64_encode('component_mode=' . Ess_M2ePro_Helper_Component_Ebay::NICK)));
