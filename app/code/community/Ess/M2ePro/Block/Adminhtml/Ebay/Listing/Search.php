    ...
    public function __construct()
    {
        ...
        if (!is_null($this->getRequest()->getParam('back'))) {
            ...
            $this->_addButton('back', array(
                ...
                'onclick'   => 'CommonHandlerObj.back_click(\''.Mage::helper('M2ePro')->getBackUrl('*/adminhtml_ebay_listing/search').'\')',
                'class'     => 'back'
            ));
        }
        ...
        $this->_addButton('goto_listings', array(
            ...
            'onclick'   => 'setLocation(\''.$this->getUrl('*/adminhtml_listing/index',array('tab' => Ess_M2ePro_Block_Adminhtml_Component_Abstract::TAB_ID_EBAY,'back'=>Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_ebay_listing/search'))).'\')',
            'class'     => 'button_link'
        ));
        ...
        $this->_addButton('view_log', array(
            ...
            'onclick'   => 'setLocation(\''.$this->getUrl('*/adminhtml_log/listing',array('back'=>Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_ebay_listing/search'), 'filter' => base64_encode('component_mode=' . Ess_M2ePro_Helper_Component_Ebay::NICK))).'\')',
            'class'     => 'button_link'
        ));
