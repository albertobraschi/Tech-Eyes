    ...
    public function getItems()
    {
        ...
        foreach ($collection as $marketplace) {
            if (!isset($items[$marketplace->getComponentMode()]['label'])) {
                $label = '';
                $marketplace->isComponentModeEbay()   && $label = Mage::helper('M2ePro')->__(Ess_M2ePro_Helper_Component_Ebay::TITLE);
                $marketplace->isComponentModeAmazon() && $label = Mage::helper('M2ePro')->__(Ess_M2ePro_Helper_Component_Amazon::TITLE);
