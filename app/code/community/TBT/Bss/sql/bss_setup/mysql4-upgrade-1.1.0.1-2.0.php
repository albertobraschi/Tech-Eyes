...
$message->setTitle("Better Store Search 2.0 Was Installed Successfully");
$message->setDescription("Better Store Search 2.0 was installed successfully. You'll need to rebuild your search indexes to use the 'Did You Mean ___?' feature.");
