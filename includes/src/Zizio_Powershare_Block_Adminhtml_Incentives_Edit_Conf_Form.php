...
- Send Coupon to your friends and get yours";
			...
			$note = "Share dialog <i>welcome</i> description (e.g. <b>Help yourself and your friends get
15% off! All you have to do is login with your Facebook account and share this coupon invitation. Using
this coupon you and your friends can enjoy the discount!</b>)";
			$alert = "This description is optional and can be used to briefly depict the steps the shopper " .
"needs to go through to get the incentive in order to make him feel more comfortable with the process, " . 
"or for an in-depth overview of the inventive.";
			$fieldset->addField('desc', 'textarea', array(
				'name'		 => 'desc',
				'label'		 => Mage::helper('powershare')->__('Detailed description'),
				'title'		 => Mage::helper('powershare')->__('Detailed description'),
				'style'		 => "height: 50px;",
				'after_element_html' => Mage::helper('powershare')->GetFieldNote($note, $alert)
			));

			$note = "Share dialog <i>footnote</i> call-for-action (e.g. <b>Share this offering and get yours</b>)";
			$alert = "The dialog footer text appears next to the share button and should encourage the shoppers to proceed with the process and click the button.
The text is a concise explanation of the task and the reward it entitles, examples: 

- Share the coupon and get yours!
- Click share to send your friends a discount 
- Share this special offer and get yours!";
			$fieldset->addField('dialog_footer_action', 'text', array(
				'name'		 => 'dialog_footer_action',
				'label'		 => Mage::helper('powershare')->__('Dialog footnote action'),
				'title'		 => Mage::helper('powershare')->__('Dialog footnote action'),
				'after_element_html' => Mage::helper('powershare')->GetFieldNote($note, $alert)
			));
